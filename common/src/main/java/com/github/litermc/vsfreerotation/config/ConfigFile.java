...
package com.github.litermc.vsfreerotation.config;
...
public abstract class ConfigFile {
	public static final String TRANSLATION_PREFIX = "gui." + Constants.MOD_ID + ".config.";
	 ...
	 */
	public static sealed abstract class Entry permits Group, Value {
	 ...
	 */
	public static non-sealed abstract class Value<T> extends Entry implements Supplier<T> {

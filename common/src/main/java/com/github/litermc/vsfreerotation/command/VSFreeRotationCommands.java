package com.github.litermc.vsfreerotation.command;
...
public final class VSFreeRotationCommands {
	public static final String ROOT_LITERAL = Constants.MOD_ID;

	private VSFreeRotationCommands() {}
	...
	public static void register(final CommandDispatcher<CommandSourceStack> dispatcher) {
		...
		// 			.executes(VSFreeRotationCommands::delete)
		// 		)
		// 	)
		// );
	}
